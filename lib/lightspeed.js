...
var lightspeed = {
  ...
  createCall: function(method, entity, options, callback){
    ...
    parameters = {
      url: _pathBuilder(entity, options.params),
      method: method
    };
    options.username = API_KEY;
    options.password = "apikey";
    _request(parameters, options, callback);
  },
  _request: function(parameters, options, callback) {
    var allowedMethods = ['get','post','put','patch','delete'];
    if (allowedMethods.indexOf(parameters.method) > -1) {
